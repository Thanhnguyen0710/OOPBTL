...
public final class BossSpawner extends AbstractSpawner<BossEnemy> {
    public BossSpawner(long createdTick, long posX, long posY, long width, long height, double spawningSize, @Nonnull Class<BossEnemy> spawningClass, long spawnInterval, long initialDelay, long numOfSpawn) {
